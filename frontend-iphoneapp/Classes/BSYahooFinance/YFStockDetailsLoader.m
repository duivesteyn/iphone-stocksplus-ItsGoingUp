...
- (void)requestDidFinish:(ASIHTTPRequest *)request
{
	...
	if (!parsedDictionary) {
        ...
        //NSLog(@"resultsCount: %d parsedDict: %@",resultCount,parsedDictionary);
        ...
        if (resultCount == 1) {
            ...
            if(stockInfo != nil) {
               ...
               // NSLog(@"YFStockDetailsLoader.m: stockInfo Found");
            }
        }
        ...
        if (self.internalStockDetails == nil) {
            self.internalError = [NSError errorWithDomain:@"YFStockDetailsLoader" code:0 userInfo:
                                  ...
                                  [NSDictionary dictionaryWithObject:@"Could not add this Ticker" forKey:NSLocalizedDescriptionKey]];
        }
    }
