...
-(void)viewWillAppear:(BOOL)animated{
    currentPriceLabel.text = @""; //clear text
...
-(IBAction)done{
    ...
    //Setting Request - Notification Default Status - notificationsOn   //Removed in 1.1. Dont want stock notifications on by default
    ...
    if ([stockTicker.text length] == 0) {
        ...
        if (![lastAddedStock isEqualToString:stockTicker.text ]) {
            ...
            if ([notificationsOn isEqualToString:@"YES"]) notificationStr = @"1"; else notificationStr = @"0";      //updated in 1.1 to have default as OFF
            ...
            //New Stock Dict Creation (must conform to current standard. "Buy Price"/Name/Notes/Notification/Symbol/"Target Price"/Units (updated in 1.1/Jan 2013 to include Above/Below/Repeats)
