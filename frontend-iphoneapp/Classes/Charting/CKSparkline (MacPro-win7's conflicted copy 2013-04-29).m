...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i=0; i<=divisions ; i++)
    {
        ...
        [text drawInRect:textFrame withFont:[[UIFont boldSystemFontOfSize:12] retain] lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentRight]; //Y Axis Text Labels
    ...
    for (int i=0; i<=2; i++)
    {
        ...
        if (chartDays == 5 ) {
            ...
            if (i== 0 ) {
                ...
                [x_label drawInRect:textFrame withFont:[[UIFont boldSystemFontOfSize:12] retain] lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentLeft]; 
                
            } else if (i== 1) {
                NSString *x_label = [formatter stringFromDate:[computedScale objectAtIndex:midDateCount]];
                [x_label drawInRect:CGRectMake(0, self.frame.size.height-17,self.frame.size.width,self.frame.size.height) withFont:[[UIFont boldSystemFontOfSize:12] retain] lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentCenter];    
                ...
                [x_label drawInRect:textFrame withFont:[[UIFont boldSystemFontOfSize:12] retain] lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];     
