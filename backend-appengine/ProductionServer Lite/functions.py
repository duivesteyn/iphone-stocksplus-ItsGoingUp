...
def testPhoneDeviceID():
    return '1AC16EA496F514E935E93DAAC049A464EF041705D30A4D809338786CB2BE1814' 
...
##Designed for Stocks+ Lite Production Server
##
def productionEnvironment():
    return '1'

def uaApiApplicationKey():
    return 'hUVVVnk4SKezZK70mP0RrA'

def uaApiApplicationKeySecret():
    return '2_MYJrYzT3G7YHQhgo1t2w' #Application Master Secret
...
#----------
def sendApplePushNotificationTest(void):
    # via UrbanAirShip
    import logging
    ...
    body = simplejson.dumps(   {"aps": {"badge": badgeNumber, "sound" : "Submarine.caf", "alert": alertMsg}, "device_tokens": [deviceToken]}  )
